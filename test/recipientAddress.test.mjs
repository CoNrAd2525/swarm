	...
	try {
		...
		const base44 = {
			asServiceRole: {
				entities: {
					Earning: {
						list: async (_sort, _pageSize, _offset, _fields) => [
							{
								id: "1",
								earning_id: "E1",
								amount: 10,
		...
		if (prevOptimize == null)
			delete process.env.AUTONOMOUS_OPTIMIZE_PAYMENT_ROUTING;
